#!/usr/bin/env python3
"""A Tkinter viewer for JSON and YAML, with a status-path list, folding, and status colouring.
...
def build_yaml_document(text: str) -> Document:
    ...
    try:
        ...
        raise JsonError(f"Not valid YAML: {exc}") from None
    ...
    def visit(
        ...
        if last > line and not root:
            ...
            document.blocks.open_of[last] = line
